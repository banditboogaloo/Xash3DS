...
BUILD		:=	build
SOURCES		:=	engine/common engine/common/imagelib engine/common/soundlib engine/common/soundlib/libmpg engine/client engine/client/vgui engine/server engine/platform/ctr
DATA		:=	engine/platform/ctr/assets
INCLUDES	:=	include engine engine/common engine/common/imagelib engine/common/soundlib engine/common/soundlib/libmpg engine/common/stb common engine/server engine/client engine/client/vgui pm_shared
GRAPHICS	:=	gfx
GFXBUILD	:=	$(BUILD)
#ROMFS		:=	romfs
